<div class="sidebar-menu">
    ...
    <div class="menu">
        <ul id="menu">
            <li><a href="{{route('admin.index')}}"><i class="fa fa-tachometer"></i> <span>Dashboard</span>
            ...
            <li><a href=""><i class="fa fa-table"></i> <span>Tables</span><span class="fa fa-angle-right"
                                                                                style="float: right"></span>
                    <div class="clearfix"></div>
                </a>
                <ul id="menu-academico-sub">
                    <li id="menu-academico-avaliacoes"><a href="{{route('admin.users.list')}}">User Table</a></li>
                    <li id="menu-academico-avaliacoes"><a href="typography.html"></a></li>
                    <li id="menu-academico-avaliacoes"><a href="faq.html"></a></li>
                </ul>
                </li>
